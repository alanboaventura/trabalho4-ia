...
print("R: Analisando os gráficos de dispersão é possível perceber que o dataset 2, composto por x2 e y2, cria uma linha "
      "de regressão polinomial. Portanto, não é apropriado para a regressão linear.")